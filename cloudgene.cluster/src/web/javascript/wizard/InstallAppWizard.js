...
Ext.ns('CloudgeneCluster.wizards');

CloudgeneCluster.wizards.ImportApp = Ext.extend(Ext.ux.Wiz, {
	...
	initComponent : function() {
		...
		Ext.apply(this, {
			...
			width : 700,
			height : 550,
			cards : [ new CloudgeneCluster.wizards.ImportAppCard() ],
			listeners : {
		...
		CloudgeneCluster.wizards.ImportApp.superclass.initComponent
...
CloudgeneCluster.wizards.ImportAppCard = Ext.extend(Ext.ux.Wiz.Card, {
	...
	initComponent : function() {
		...
		Ext.apply(this, {
			...
			items : [{
				...
				items : [ new CloudgeneCluster.wizards.cards.AppList() ]
			}, {
		...
		// call parent
		CloudgeneCluster.wizards.ImportAppCard.superclass.initComponent.apply(this,
				arguments);
