...
Ext.ns('CloudgeneCluster.wizards.cards');

CloudgeneCluster.wizards.cards.AppList = Ext
	.extend(
		Ext.DataView,
		{
			...
			// call parent
			CloudgeneCluster.wizards.cards.AppList.superclass.initComponent
...
Ext.reg('applist', CloudgeneCluster.wizards.cards.AppList);
