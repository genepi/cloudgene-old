...
=========
1. Clone both repository https://github.com/genepi/cloudgene.git **and* https://github.com/genepi/cloudgene-samples.git. conf/settings.yaml define the relative bath to each other
2. 
  * Start **Cloudgene-Cluster**, use the username 'cloudgene' and pwd 'cloud' to login at http://localhost:8085
  * Start **Cloudgene-MapRed**, create a user by adding the program argument "--add-user <user> <pwd> --admin" and login at http://localhost:8082